...
/// the pocket-tts and voice attribution and the four project links (privacy policy, support, the Windows project, platform limitations).
struct AboutInfo: Equatable, Sendable {
    ...
    static let privacyPolicyURL = URL(string: "https://github.com/mchrisgm/ReVoxMobile/blob/main/docs/privacy.md")!
    static let supportURL = URL(string: "https://github.com/mchrisgm/ReVoxMobile/issues")!
