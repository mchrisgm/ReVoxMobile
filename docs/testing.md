...
7. Open **Settings → About**. Expected: the app version, the privacy paragraph, five licence links (WhisperKit, FluidAudio, pocket-tts Core ML weights with the Kyutai and voice attribution, Silero VAD, Whisper weights) that open in Safari, and the two project links.
